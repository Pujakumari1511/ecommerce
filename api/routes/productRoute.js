...
const { getAllProducts, getProductDetails, getProducts, searchProductsUsingAI } = require('../controllers/productController');
...
router.route('/products/search').get(searchProductsUsingAI);
